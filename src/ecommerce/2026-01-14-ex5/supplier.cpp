#include <ecommerce/2026-01-14-ex5/supplier.hpp>

#include <random>

Supplier::Supplier(int id, System& system, Network& network,
...
void Supplier::update(TimerEnded) {
  ...
  network_.submitSupply(id_, server_id, product_id, quantity);
