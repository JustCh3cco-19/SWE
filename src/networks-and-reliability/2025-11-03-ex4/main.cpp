...
#include <networks-and-reliability/2025-11-03-ex4/parser.hpp>
#include <networks-and-reliability/2025-11-03-ex4/simulation.hpp>
...
int main() {
  ...
  if (!mocc_utils::WriteResultsToFile("results.txt",
    ...
    output << std::setprecision(8) << rate << "\n";
  }, &error)) {
    std::cerr << error << "\n";
    return 1;
  }
